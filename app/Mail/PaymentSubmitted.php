...
class PaymentSubmitted extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(subject: "Unity Circle – Payment Submission Received for {$month} {$this->submission->year}");
    }

    public function content(): Content
    {
        return new Content(view: 'emails.payment-submitted-member');
    }
}
