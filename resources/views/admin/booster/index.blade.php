...
<div class="space-y-5 max-w-screen-xl">
    ...
    <div class="flex justify-between items-center">
        <p class="text-sm text-gray-500">{{ $drives->count() }} drive(s)</p>
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-50">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-5 py-3 text-right text-gray-700">৳{{ number_format($d->total_expected, 0) }}</td>
                    <td class="px-5 py-3 text-right text-emerald-600 font-medium">৳{{ number_format($d->total_deposited, 0) }}</td>
                    <td class="px-5 py-3 text-right text-red-600">৳{{ number_format($d->total_due, 0) }}</td>
                ...
                @empty
                <tr><td colspan="9" class="px-5 py-10 text-center text-gray-400">No Booster Contribution drives yet.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
