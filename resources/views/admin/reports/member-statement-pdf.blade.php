...
<head>
<meta charset="utf-8">
<title>Statement – {{ $member->member_number }}</title>
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    /* Header */
    .org-header { text-align: center; border-bottom: 2px solid #1d4ed8; padding-bottom: 12px; margin-bottom: 20px; }
    ...
    /* Member info */
    .member-box { background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 4px; padding: 12px 16px; margin-bottom: 20px; }
    .member-grid { display: table; width: 100%; }
    .member-col { display: table-cell; width: 50%; vertical-align: top; padding: 3px 0; }
    ...
    /* Summary */
    .summary { display: table; width: 100%; margin-bottom: 20px; border-collapse: separate; border-spacing: 8px; }
    .sum-cell { display: table-cell; text-align: center; border: 1px solid #e5e7eb; border-radius: 4px; padding: 10px 8px; }
    .sum-label { font-size: 9px; color: #6b7280; text-transform: uppercase; letter-spacing: 0.5px; }
    ...
    thead th { background: #1d4ed8; color: #fff; padding: 7px 8px; text-align: left; font-size: 9px; text-transform: uppercase; letter-spacing: 0.4px; }
    thead th.right { text-align: right; }
    tbody tr:nth-child(even) { background: #f9fafb; }
    tbody td { padding: 6px 8px; border-bottom: 1px solid #f3f4f6; vertical-align: middle; }
    tbody td.right { text-align: right; }
    tfoot td { padding: 7px 8px; font-weight: bold; background: #f1f5f9; border-top: 2px solid #1d4ed8; }
...
<div class="page">
    ...
    <div class="org-header">
        ...
        <div class="doc-title">Member-wise Contribution Statement — {{ $year }}</div>
    </div>
    ...
    <div class="member-box">
        ...
        <div class="member-grid" style="margin-top:8px;">
            ...
            <div class="member-col">
                ...
                <div class="value">{{ $member->join_date->format('d M Y') }}</div>
            </div>
        </div>
        <div class="member-grid" style="margin-top:8px;">
            <div class="member-col">
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
            <tr><td colspan="8" style="text-align:center; color:#9ca3af; padding: 20px;">No records for {{ $year }}.</td></tr>
            @endforelse
        </tbody>
        @if(count($rows) > 0)
        <tfoot>
    ...
    <div class="footer">
        Confidential — Unity Circle · This is a computer-generated statement. No signature required.
    </div>
</div>
</body>
</html>
