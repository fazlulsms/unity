...
<head>
    ...
    <title>@yield('title', 'Portal') — Unity Club</title>
...
<div class="flex h-screen overflow-hidden" x-data="{ sidebarOpen: false }">
    ...
    <aside x-bind:class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
        ...
        <div class="flex items-center gap-3 px-5 h-16 border-b border-slate-800 shrink-0">
            ...
            <div class="min-w-0">
                <p class="text-white font-bold text-sm leading-none">Unity Club</p>
    ...
    {{-- ── MAIN CONTENT ─────────────────────────────────────── --}}
    <div class="flex flex-1 flex-col min-w-0 overflow-hidden bg-gray-50">

        {{-- Top header --}}
        <header class="shrink-0 flex items-center gap-4 h-16 bg-white border-b border-gray-200 px-6">
            {{-- Mobile menu toggle --}}
