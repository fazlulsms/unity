...
<div class="max-w-screen-lg space-y-5">
    ...
    <div class="grid sm:grid-cols-3 gap-4">
        <div class="card p-5 border-t-4 border-emerald-500">
            <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Total Paid</p>
            <p class="text-2xl font-bold text-emerald-600">৳{{ number_format($totalPaid, 0) }}</p>
            <p class="text-xs text-gray-400 mt-1">Lifetime approved payments</p>
        </div>
        <div class="card p-5 border-t-4 border-red-400">
            <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Amount Due</p>
