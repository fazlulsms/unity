...
@section('title', 'Transparency Dashboard — Unity Circle')

@section('content')
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    <div class="mb-8">
        <h1 class="text-2xl font-bold text-gray-900">Public Transparency Dashboard</h1>
        <p class="text-gray-500 mt-1 text-sm">Real-time financial summary of Unity Circle — updated automatically.</p>
    </div>
